...
//
    ...
    public void removeUserById(long id) {
        ...
        try(Connection connection = Util.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(removeUserId)
        ) {
    ...
    public List<User> getAllUsers()  {
        ...
        try (Connection connection = Util.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(sqlList)){
    ...
    public void cleanUsersTable() {
        ...
        try (Connection connection = Util.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(deleteTableData)){
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
        }
